 ...
 *         &lt;element ref="{https://github.com/hongjinqiu/javameta/template}column-model" minOccurs="0"/>
...
@XmlRootElement(name = "auto-column")
public class AutoColumn extends Column implements Serializable {
	private static final long serialVersionUID = 1L;

    @XmlElement(name = "column-attribute")
    protected List<ColumnAttribute> columnAttribute;
    protected Editor editor;
    @XmlElement(name = "column-model")
     ...
     *     
     */
    public void setColumnModel(ColumnModel value) {
